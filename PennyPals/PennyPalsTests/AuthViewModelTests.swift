...
struct AuthViewModelTests {
    ...
    func testInitialAuthState() {
        ...
        #expect(currentUser == nil, "Data currentUser harus nil saat baru dibuka")
    }
    ...
    func testNewUserCreation(){
        ...
        let newUser = UserModel(
                    ...
                    nextPenaltyCheck: Calendar.current.date(byAdding: .day, value: 2, to: Date())!
                )
        
        #expect(newUser.coins == 0, "Koin awal harus 0")
        #expect(newUser.streak == 9, "Streak Awal harus 0")
        #expect(newUser.isSafeFromPenalty == true, "User baru harus aman dari penalty")
    }
}
