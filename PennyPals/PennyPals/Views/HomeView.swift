        ...
        NavigationStack {
            VStack(spacing: 16) {
                ...
                HStack {
                    HStack {
                        Circle()
                            ...
                            .overlay(
                                Text("JM").font(.headline).foregroundColor(
                                    .white
                                )
                            )
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Text("Jamie").font(.headline).foregroundColor(
                                .pennyText
                            )
                        }
                    }
                ...
                VStack(spacing: 16) {
                    VStack(spacing: 8) {
                        HStack {
                            Text("Pet XP").font(.subheadline.weight(.medium))
                                .foregroundColor(.pennySecondaryText)
                            Spacer()
                            Text("720 / 1000").font(.subheadline.bold())
                    ...
                    HStack(spacing: 16) {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text("Next check 2d").font(.caption2)
                                .foregroundColor(.pennySecondaryText)
                        }
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Label("Wishlist", systemImage: "target")
                                .font(.caption.weight(.medium))
                                .foregroundColor(.pennyPurple)
                            Text("AirPods Pro").font(
                                .subheadline.weight(.semibold)
                            ).lineLimit(1)
                            ProgressView(value: 1.8, total: 4.0)
                                .tint(.blue)
                            Text("Rp 1,8jt / Rp 4jt").font(.caption2)
                                .foregroundColor(.pennySecondaryText)
                        }
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .padding()
