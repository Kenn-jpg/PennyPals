...
struct PetModel: Identifiable, Codable, Equatable {
    ...
    /// Jenis ras atau varian hewan peliharaan (contoh: "Cat", "Dog", "Owl").
    var type: String

    /// Poin pengalaman (XP) saat ini pada level yang sedang berjalan.
    var xp: Int
    ...
    /// Rumus dinamis: Level 0 -> 200 XP, Level 1 -> 400 XP, Level 2 -> 600 XP, dst.
    var maxXP: Int {
        return (level + 1) * 200
    }
}
